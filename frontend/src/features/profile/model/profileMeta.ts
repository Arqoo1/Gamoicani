...
export const COVER_GRADIENTS: Array<[string, string]> = [
  ["#0f4c35", "#2f9e5d"],
  ["#1a1a2e", "#48c978"],
  ["#0d1b2a", "#2176ae"],
  ["#2d0037", "#9b5de5"],
...
export const SHOP_ITEMS_META: Record<
  string,
  { category: string; emoji?: string; color?: string; colors?: string[] }
> = {
...
export function getProfileStatsSummary(
  user: Pick<AuthUser, "gameStats"> | null | undefined
): ProfileStatsSummary {
